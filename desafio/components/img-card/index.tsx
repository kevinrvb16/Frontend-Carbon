const ImgCard = () => {
    return (
        <div className="brightness-[.99] bg-cover bg-[url('fundo.jpg')] p-10 align-middle m-10 rounded-lg border h-[520px] border-gray-200  md:max-w-6xl dark:border-gray-300">
            <div className="align-middle">
                ...
                <p className="mb-3 w-[400px] text-lg text-white drop-shadow-lg">Members save 30% or more on select hotels—and enjoy the experiences that matter most*</p>
